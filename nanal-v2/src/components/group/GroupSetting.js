      ...
      <MobileView>
        <div className='justify-center text-center'>
          ...
          <div className='justify-center w-full my-2 text-center'>
            <div className=''>
              <img src={groupDetail.imgUrl} className='inline-block p-1 rounded-md w-28 h-28'></img>
            ...
            <div>
              <Link to={`/Group/Update`} state={{ groupDetail: groupDetail.groupIdx }}>
          ...
          {friendList[0] === '아직은 친구가 없습니다.' ? (
            ...
            friendList.map((friendItem, idx) => <FriendItem key={idx} item={friendItem} />)
          )}
        </div>
      </MobileView>
      <BrowserView>
